...
public class AuthorizationService : IAuthorizationService
{
    ...
    public async Task<string> SendDoctorInfoForRegistrationAsync(DoctorDTO request, string password,
        CancellationToken cancellationToken)
    {
        ...
        if (!response.IsSuccessStatusCode) throw new Exception(responseStream);

        return responseStream;
    }

    public async Task<string> SendReceptionistInfoForRegistrationAsync(ReceptionistDTO request, string password,
        CancellationToken cancellationToken)
    {
        var payload = new Dictionary<string, string>
        {
