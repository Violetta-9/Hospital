...
namespace Documents.API.Client
{
    public class DocumentApiProxy : IDocumentApiProxy
    {
        ...
        public DocumentApiProxy(IDocumentApiHttpClientProvider httpClientProvider, IOptions<DocumentApiOptions> documentOptions)
        {
        ...
        public async Task<long> UploadBlobAsync(FileParameter file, long entityId, SubjectUpdate subjectUpdate, CancellationToken cancellationToken)
        {
