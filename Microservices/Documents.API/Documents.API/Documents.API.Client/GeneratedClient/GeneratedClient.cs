...
namespace Documents.API.Client.GeneratedClient
{
    ...
    public partial class DocumentApi
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<long> UpdateBlobAsync(FileParameter file, long? photoId, SubjectUpdate? subject)
        {
            return UpdateBlobAsync(file, photoId, subject, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<long> UpdateBlobAsync(FileParameter file, long? photoId, SubjectUpdate? subject, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Document");
