...
{
    public static void BasedMapping<T>(this EntityTypeBuilder<T> builder)
        where T : class, IAudientable, IIdentifiable<long>
    {
    ...
    public static void MapAuditProperty<T>(this EntityTypeBuilder<T> builder) where T : class, IAudientable
    {
        ...
        builder.Property(x => x.LastRowModificationTimestamp)
            .HasColumnName(nameof(Account.LastRowModificationTimestamp)).IsRequired();
    }
